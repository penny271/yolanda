...
sleep(2)
driver.get('https://www.trefac.jp/store/t2c94psb/?srchword=Louis%20Vuitton&step=1&disp_num=90&order=pdown')
...
base_url ='https://www.trefac.jp/store/t2c94psb/?srchword=Louis%20Vuitton&step=1&disp_num=90&order=pdown&key={}'
...
for i in range(1):
    ...
    for i, a_tag in enumerate(a_tags):
        ...
        d_list.append({
            ...
            'URef-title-completed':'"=H2&" "&"ship from Japan',
            'Ref-len()': '"¥=len(D2)',
            'Ref-material_translation': '"=if(AG2="","",googletranslate(AG2,"ja","en"))',
            'URef-size_for_ConditionDescription': '"=M2&" | "&N2&" | "&" Model: "&AF2&" | "&"Material: "&K2&" | "&"An item has been used previously. For more details, please check the pictures carefully and judge the condition.',
...
df_complete.to_excel('tf_LOUIS-VUITTON_bag_women_ver2_' + today + '.xlsx', index=False)
