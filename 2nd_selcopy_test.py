...
#! get all DL_pics_list in here => [ [],[],[]     ] 多次元リストを作成
combined_pics_list = []

#^ 絞り込みした複数の条件のときのurlを下記にペーストする
driver.get('https://www.2ndstreet.jp/search?keyword=Roberto+Cavalli&minPrice=&maxPrice=3200&selected_category=&search=%E6%9D%A1%E4%BB%B6%E3%82%92%E8%A8%AD%E5%AE%9A%E3%81%99%E3%82%8B&category=')

base_url = 'https://www.2ndstreet.jp/search?keyword=Roberto+Cavalli&minPrice=&maxPrice=3200&selected_category=&search=%E6%9D%A1%E4%BB%B6%E3%82%92%E8%A8%AD%E5%AE%9A%E3%81%99%E3%82%8B&category=&page={}'
    ...
    for index, product in enumerate(products_page):
        ...
        if page_soup.select_one('dt:-soup-contains("型番")+dd'):
            ...
            d_list.append({
                ...
                'DL-combined_pics_list': 'pics_set='+ str(combined_pics_list),
...
df_complete.to_excel('2st_zzzTest_bag_men_ver2_.xlsx', index=False)
