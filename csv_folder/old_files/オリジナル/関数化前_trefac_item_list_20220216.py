...
sleep(2)
driver.get('https://www.trefac.jp/store/t1cpsb/?srchword=campomaggi&step=1')
...
base_url ='https://www.trefac.jp/store/t1cpsb/?srchword=campomaggi&step=1&key={}'
...
for i in range(1):
  ...
  for i, a_tag in enumerate(a_tags):
    ...
    d_list.append({
      ...
      'X-title_category_combined':'=D2&" "&E2',
      'Ref-translation':'"=if(AB2="","",googletranslate(AB2,"ja","en"))',
      ...
      'DL-ebay-category': 'bag_m:52357 / bag_w:169291',
...
df.to_csv('tf_ccccccc_bag_men_ver2_' + today + '.csv', index=None, encoding='utf-8-sig')
