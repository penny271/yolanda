...
driver.get('https://www.trefac.jp/store/t2c94psb/?srchword=Tory+Burch&step=1&order=pdown&disp_num=90')
sleep(2)
...
base_url ='https://www.trefac.jp/store/t2c94psb/?srchword=Tory+Burch&step=1&order=pdown&disp_num=90&key={}'
...
file_name = 'tf_ToryBurch2_200-500k_bag_women_ver2_'
